...
import { UpdateCauseComponent } from './UpdateCause.component';
...
describe('UpdateCauseComponent', () => {
  ...
  let mockUpdateCauseService;
  let mockDataService

  beforeEach(async(() => {

    mockUpdateCauseService = sinon.createStubInstance(UpdateCauseService);
    mockUpdateCauseService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: UpdateCauseService, useValue: mockUpdateCauseService },
