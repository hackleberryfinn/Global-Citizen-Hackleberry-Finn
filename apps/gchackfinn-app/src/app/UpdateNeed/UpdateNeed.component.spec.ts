...
import { UpdateNeedComponent } from './UpdateNeed.component';
...
describe('UpdateNeedComponent', () => {
  ...
  let mockUpdateNeedService;
  let mockDataService

  beforeEach(async(() => {

    mockUpdateNeedService = sinon.createStubInstance(UpdateNeedService);
    mockUpdateNeedService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: UpdateNeedService, useValue: mockUpdateNeedService },
