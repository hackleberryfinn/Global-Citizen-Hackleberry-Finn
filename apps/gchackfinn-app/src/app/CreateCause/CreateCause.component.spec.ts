...
describe('CreateCauseComponent', () => {
  ...
  let mockCreateCauseService;
  let mockDataService

  beforeEach(async(() => {

    mockCreateCauseService = sinon.createStubInstance(CreateCauseService);
    mockCreateCauseService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CreateCauseService, useValue: mockCreateCauseService },
